...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Plugin.MediaManager.MediaServiceConnection`1, Plugin.MediaManager, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", MediaServiceConnection_1.class, __md_methods);
	}


	public MediaServiceConnection_1 () throws java.lang.Throwable
	{
		super ();
		if (getClass () == MediaServiceConnection_1.class)
			mono.android.TypeManager.Activate ("Plugin.MediaManager.MediaServiceConnection`1, Plugin.MediaManager, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
