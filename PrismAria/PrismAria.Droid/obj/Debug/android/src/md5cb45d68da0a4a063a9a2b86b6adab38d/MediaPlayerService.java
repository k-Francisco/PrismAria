...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Plugin.MediaManager.MediaPlayerService, Plugin.MediaManager, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", MediaPlayerService.class, __md_methods);
	}
	...
	public MediaPlayerService () throws java.lang.Throwable
	{
		...
		if (getClass () == MediaPlayerService.class)
			mono.android.TypeManager.Activate ("Plugin.MediaManager.MediaPlayerService, Plugin.MediaManager, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
