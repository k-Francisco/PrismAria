...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Plugin.MediaManager.MediaServiceBase, Plugin.MediaManager, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", MediaServiceBase.class, __md_methods);
	}


	public MediaServiceBase () throws java.lang.Throwable
	{
		super ();
		if (getClass () == MediaServiceBase.class)
			mono.android.TypeManager.Activate ("Plugin.MediaManager.MediaServiceBase, Plugin.MediaManager, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
