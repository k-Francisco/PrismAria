package md53d5f0cc5bc3d159e4c43dbc94515da23;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Plugin.MediaManager.MediaSession.MediaSessionCallback, Plugin.MediaManager, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", MediaSessionCallback.class, __md_methods);
	}


	public MediaSessionCallback () throws java.lang.Throwable
	{
		super ();
		if (getClass () == MediaSessionCallback.class)
			mono.android.TypeManager.Activate ("Plugin.MediaManager.MediaSession.MediaSessionCallback, Plugin.MediaManager, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
